<p><strong>NO PURCHASE OR PAYMENT OF ANY KIND IS NECESSARY TO ENTER FOR A CHANCE TO WIN THIS
SWEEPSTAKES. A PURCHASE WILL NOT INCREASE YOUR CHANCES OF WINNING. PROMOTION OPEN
ONLY TO LEGAL RESIDENTS OF THE UNITED STATES OR DISTRICT OF COLUMBIA WHO ARE AT LEAST
18 YEARS OLD AND THE AGE OF MAJORITY FOR THE RESIDENT’S RESPECTIVE STATE ON DATE OF
...
the “Promotion Entities”) and the immediate family members (parent, child, sibling, and spouse of each) of and/or
persons living in the same household as such individuals (whether related or not) are not eligible to participate. This
...
use and privacy notice found at Twitter.com. Normal time, toll, connection and usage rates, if any, charged by
your Internet service provider will apply. By successfully transmitting your tweet as directed, you will receive one
...
registered with Twitter.com or email account. Proof of sending will not be deemed to be proof of receipt. All entries
become the exclusive property of Sponsor and will not be acknowledged or returned. Anyone found to use multiple
accounts is ineligible and multiple entries during a single day (to the extent multiple entries are permitted under
these Rules) will not be accepted. Any use of robotic, automatic, programmed or similar entry methods will void all
such entries by such methods and such senders. Incomplete, inaccurate, or incorrect entries are void. No other
form of entry will be accepted. In the event of a dispute over the identity of any potential winner, the entry will be
declared made by the authorized account holder of the Twitter account or email address submitted at the time of
...
collected from the Sweepstakes shall be used only in a manner consistent with the consent given by the entrants at
the time of entry, with these Rules, and with the Sponsor’s Privacy Policy found at https://www.53.com/site/global/
...
a winner of any prize until your eligibility with these Rules has been confirmed. Sponsor will attempt to notify each
potential winner via direct message on Twitter within one (1) day of the prize drawing using the Twitter account
provided at time of entry (it is each entrant’s/winner’s sole responsibility to change account settings, as necessary,
...
will be awarded “as is” without any warranties, guarantees or representation of any kind, expressed or implied
(including without limitation, any implied warranty of merchantability or fitness for a particular purpose). Promotion
Entities, in their discretion, may substitute a prize of equal value or greater approximate value and comparable use
for any reason. All taxes (including federal and state income taxes) and any other expenses on the receipt and use
of prize are solely the responsibility of the winner(s). Any winner who receives at least $600.00 or more in prizes
...
disqualify any individual suspected of tampering with the entry process or the operation of the Sweepstakes; or to
be acting in any manner deemed by Sponsor to be in violation of the Rules; or to be acting in any manner deemed
by Sponsor to be unsportsmanlike or disruptive, or with intent to annoy, abuse, threaten or harass any other person.
CAUTION: ANY ATTEMPT BY A USER OR ENTRANT OR ANY OTHER INDIVIDUAL TO DELIBERATELY
DAMAGE ANY WEB SITE OR UNDERMINE THE LEGITIMATE OPERATION OF THE SWEEPSTAKES IS
A VIOLATION OF CRIMINAL AND CIVIL LAWS AND SHOULD SUCH AN ATTEMPT BE MADE, SPONSOR
RESERVES THE RIGHT TO SEEK DAMAGES AND COSTS (INCLUDING WITHOUT LIMITATION, ATTORNEYS’
FEES) FROM ANY SUCH PERSON TO THE FULLEST EXTENT PERMITTED BY LAW. Sponsor’s failure to
enforce any terms of these Rules shall not constitute a waiver of that or any other provision. In the event there is
a discrepancy between disclosures and other statements contained in the Sweepstakes materials and terms and
...
operation or communications line failure, regardless of cause, with regard to any equipment, systems, networks,
lines, satellites, servers, computers or providers utilized in any aspect of the operation of the Sweepstakes; (d)
inaccessibility or unavailability of the Internet or any combination thereof; or (e) any injury or damage to participant’s
or to any other person's electronic device which may be related to or resulting from any attempt to participate
in the Sweepstakes or download any materials in the Sweepstakes. If, for any reason, the Sweepstakes is not
...
or warranties of any kind concerning the appearance, safety, or performance of any prize. Except for residents of
...
out-of-pocket costs incurred, including costs associated with entering this Sweepstakes but in no event attorneys’
fees; and (iii) under no circumstances will entrant be permitted to obtain awards for and entrant hereby waives all
rights to claim punitive, incidental and/or consequential damages and any other damages, other than for actual
